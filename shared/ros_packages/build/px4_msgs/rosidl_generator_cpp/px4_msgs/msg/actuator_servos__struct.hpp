...
#ifndef PX4_MSGS__MSG__ACTUATOR_SERVOS__STRUCT_HPP_
#define PX4_MSGS__MSG__ACTUATOR_SERVOS__STRUCT_HPP_
...
struct ActuatorServos_
{
  ...
  explicit ActuatorServos_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ActuatorServos_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : control(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__ACTUATOR_SERVOS__STRUCT_HPP_
