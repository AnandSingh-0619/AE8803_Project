...
#ifndef PX4_MSGS__MSG__AUTOTUNE_ATTITUDE_CONTROL_STATUS__STRUCT_HPP_
#define PX4_MSGS__MSG__AUTOTUNE_ATTITUDE_CONTROL_STATUS__STRUCT_HPP_
...
struct AutotuneAttitudeControlStatus_
{
  ...
  explicit AutotuneAttitudeControlStatus_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit AutotuneAttitudeControlStatus_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : coeff(_alloc),
    coeff_var(_alloc),
    rate_sp(_alloc)
  {
...
#endif  // PX4_MSGS__MSG__AUTOTUNE_ATTITUDE_CONTROL_STATUS__STRUCT_HPP_
