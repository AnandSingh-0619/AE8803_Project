...
#ifndef PX4_MSGS__MSG__EVENT__STRUCT_HPP_
#define PX4_MSGS__MSG__EVENT__STRUCT_HPP_
...
struct Event_
{
  ...
  explicit Event_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit Event_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : arguments(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__EVENT__STRUCT_HPP_
