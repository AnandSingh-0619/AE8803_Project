...
#ifndef PX4_MSGS__MSG__ACTUATOR_MOTORS__STRUCT_HPP_
#define PX4_MSGS__MSG__ACTUATOR_MOTORS__STRUCT_HPP_
...
struct ActuatorMotors_
{
  ...
  explicit ActuatorMotors_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ActuatorMotors_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : control(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__ACTUATOR_MOTORS__STRUCT_HPP_
