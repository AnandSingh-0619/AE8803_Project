...
#ifndef PX4_MSGS__MSG__INTERNAL_COMBUSTION_ENGINE_STATUS__STRUCT_HPP_
#define PX4_MSGS__MSG__INTERNAL_COMBUSTION_ENGINE_STATUS__STRUCT_HPP_
...
struct InternalCombustionEngineStatus_
{
  ...
  explicit InternalCombustionEngineStatus_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit InternalCombustionEngineStatus_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__INTERNAL_COMBUSTION_ENGINE_STATUS__STRUCT_HPP_
