...
#ifndef PX4_MSGS__MSG__ACTUATOR_CONTROLS_STATUS__STRUCT_HPP_
#define PX4_MSGS__MSG__ACTUATOR_CONTROLS_STATUS__STRUCT_HPP_
...
struct ActuatorControlsStatus_
{
  ...
  explicit ActuatorControlsStatus_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ActuatorControlsStatus_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // PX4_MSGS__MSG__ACTUATOR_CONTROLS_STATUS__STRUCT_HPP_
