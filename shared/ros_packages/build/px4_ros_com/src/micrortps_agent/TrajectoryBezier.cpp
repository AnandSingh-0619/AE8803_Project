...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10d68fcd
    m_timestamp = 0;
    // m_position com.eprosima.idl.parser.typecode.AliasTypeCode@117e949d
    memset(&m_position, 0, (3) * 4);
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6db9f5a4
    m_yaw = 0.0;
    // m_delta com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5f8edcc5
    m_delta = 0.0;
