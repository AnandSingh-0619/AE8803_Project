...
px4_msgs::msg::TrajectoryWaypoint::TrajectoryWaypoint()
{
    ...
    // m_velocity com.eprosima.idl.parser.typecode.AliasTypeCode@78691363
    memset(&m_velocity, 0, (3) * 4);
    // m_acceleration com.eprosima.idl.parser.typecode.AliasTypeCode@78691363
    memset(&m_acceleration, 0, (3) * 4);
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@41d477ed
    m_yaw = 0.0;
    // m_yaw_speed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3590fc5b
    m_yaw_speed = 0.0;
    // m_point_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@397fbdb
    m_point_valid = false;
    // m_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@33d512c1
    m_type = 0;
