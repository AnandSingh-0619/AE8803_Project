...
px4_msgs::msg::VehicleStatus::VehicleStatus()
{
    ...
    m_timestamp = 0;
    // m_nav_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@61d6015a
    m_nav_state = 0;
    // m_nav_state_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2525ff7e
    m_nav_state_timestamp = 0;
    // m_arming_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@524d6d96
    m_arming_state = 0;
    // m_hil_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@152aa092
    m_hil_state = 0;
    // m_failsafe com.eprosima.idl.parser.typecode.PrimitiveTypeCode@44a7bfbc
    m_failsafe = false;
    // m_failsafe_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4ef37659
    m_failsafe_timestamp = 0;
    // m_system_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@776b83cc
    m_system_type = 0;
    // m_system_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@37858383
    m_system_id = 0;
    // m_component_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4e268090
    m_component_id = 0;
    // m_vehicle_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1bb266b3
    m_vehicle_type = 0;
    // m_is_vtol com.eprosima.idl.parser.typecode.PrimitiveTypeCode@306cf3ea
    m_is_vtol = false;
    // m_is_vtol_tailsitter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2beee7ff
    m_is_vtol_tailsitter = false;
    // m_vtol_fw_permanent_stab com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5136d012
    m_vtol_fw_permanent_stab = false;
    // m_in_transition_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5939a379
    m_in_transition_mode = false;
    // m_in_transition_to_fw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@e1de817
    m_in_transition_to_fw = false;
    // m_rc_signal_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@52102734
    m_rc_signal_lost = false;
    // m_rc_input_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3541cb24
    m_rc_input_mode = 0;
    // m_data_link_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2177849e
    m_data_link_lost = false;
    // m_data_link_lost_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@40cb8df7
    m_data_link_lost_counter = 0;
    // m_high_latency_data_link_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@13b13b5d
    m_high_latency_data_link_lost = false;
    // m_engine_failure com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2892dae4
    m_engine_failure = false;
    // m_mission_failure com.eprosima.idl.parser.typecode.PrimitiveTypeCode@355ce81c
    m_mission_failure = false;
    // m_geofence_violated com.eprosima.idl.parser.typecode.PrimitiveTypeCode@29647f75
    m_geofence_violated = false;
    // m_failure_detector_status com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3315d2d7
    m_failure_detector_status = 0;
    // m_onboard_control_sensors_present com.eprosima.idl.parser.typecode.PrimitiveTypeCode@d6e7bab
    m_onboard_control_sensors_present = 0;
    // m_onboard_control_sensors_enabled com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5fa07e12
    m_onboard_control_sensors_enabled = 0;
    // m_onboard_control_sensors_health com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55b53d44
    m_onboard_control_sensors_health = 0;
    // m_latest_arming_reason com.eprosima.idl.parser.typecode.PrimitiveTypeCode@482bce4f
    m_latest_arming_reason = 0;
    // m_latest_disarming_reason com.eprosima.idl.parser.typecode.PrimitiveTypeCode@366647c2
    m_latest_disarming_reason = 0;
    // m_armed_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a6afff2
    m_armed_time = 0;
    // m_takeoff_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1649b0e6
    m_takeoff_time = 0;
